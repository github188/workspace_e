...
function showStaffWin(fn, id) {
	...
	var topSelectPanel = new Ext.form.FieldSet({
		...
		items : [{
					...
					handler : function() {
						storeR.baseParams = {
							"staffFindBean.staffName" : itemFromId(
									topSelectPanel, "log_staffName").getValue(),
							"staffFindBean.deptName" : itemFromId(
									topSelectPanel, "log_deptName").getValue(),
							"staffFindBean.staffNo" : itemFromId(
									topSelectPanel, "log_staffNo").getValue()
						};
						storeR.load();
					}
				}]
...
var logQueryStore = new Ext.data.JsonStore({
			// fields : ["orgName", "staffNo", "staffName", "opTime",
			// "protItemNo",
			// "opTypeName", "opObjName", "protocolNo", "curValue", "opModule",
			// "opButton", "ipAddr", "consNo", "consName", "bigName",
			// "smallName"],
			fields : ["orgName", "staffNo", "staffName", "opTime",
					"protItemNo", "opTypeName", "opObjName", "opObjNo",
					"protocolNo", "curValue", "curStatus", "opModule",
					"opButton", "ipAddr", "consNo", "consName", "bigName",
					"smallName"],
			root : "resultList",
			totalProperty : "totalCount",
...
Ext.onReady(function() {
	...
	window.dataType
			&& Ext.getCmp('日志查询').fireEvent("activate", Ext.getCmp('日志查询'));
		// if(){}
	});