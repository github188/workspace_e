...
Ext.ux.form.MultiSelect = Ext.extend(Ext.form.Field,  {
	...
	this.multiSelect=config.multiSelect===false?false:true,
	Ext.ux.form.MultiSelect.superclass.constructor.call(this,config);
	},
	multiSelect:true,
    /**
    ...
    onRender: function(ct, position){
        ...
        this.view = new Ext.ListView({
            ...
            columns: [{ 
            	...
            	tpl:'<span ext:qtip="{'+this.displayField+'}">{'+this.displayField+'}</span>'
            }],
            hideHeaders: true
        });	
