...
/**
 * LUpCommMsgLogId entity. @author MyEclipse Persistence Tools
 */

public class LUpCommMsgLogId implements java.io.Serializable {
	...
	/** default constructor */
	public LUpCommMsgLogId() {
	}

	/** full constructor */
	public LUpCommMsgLogId(String terminalAddr, String tmnlCode,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof LUpCommMsgLogId))
			return false;
		LUpCommMsgLogId castOther = (LUpCommMsgLogId) other;
