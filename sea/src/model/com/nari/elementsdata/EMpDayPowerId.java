...
/**
 * EMpDayPowerId entity. @author MyEclipse Persistence Tools
 */

public class EMpDayPowerId implements java.io.Serializable {
	...
	/** default constructor */
	public EMpDayPowerId() {
	}

	/** minimal constructor */
	public EMpDayPowerId(Long dataId, Date dataDate) {
		this.dataId = dataId;
		this.dataDate = dataDate;
	}

	/** full constructor */
	public EMpDayPowerId(Long dataId, Date dataDate, Double ct, Double pt,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof EMpDayPowerId))
			return false;
		EMpDayPowerId castOther = (EMpDayPowerId) other;
