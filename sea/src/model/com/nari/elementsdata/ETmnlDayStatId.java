...
/**
 * ETmnlDayStatId entity. @author MyEclipse Persistence Tools
 */

public class ETmnlDayStatId implements java.io.Serializable {
	...
	/** default constructor */
	public ETmnlDayStatId() {
	}

	/** full constructor */
	public ETmnlDayStatId(String tmnlAssetNo, Date dataDate, Boolean mark,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ETmnlDayStatId))
			return false;
		ETmnlDayStatId castOther = (ETmnlDayStatId) other;
