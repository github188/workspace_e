...
/**
 * EMpDayPowerLogId entity. @author MyEclipse Persistence Tools
 */

public class EMpDayPowerLogId implements java.io.Serializable {
	...
	/** default constructor */
	public EMpDayPowerLogId() {
	}

	/** minimal constructor */
	public EMpDayPowerLogId(Long dataId, Date dataDate) {
		this.dataId = dataId;
		this.dataDate = dataDate;
	}

	/** full constructor */
	public EMpDayPowerLogId(Long dataId, Date dataDate, Double ct, Double pt,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof EMpDayPowerLogId))
			return false;
		EMpDayPowerLogId castOther = (EMpDayPowerLogId) other;
