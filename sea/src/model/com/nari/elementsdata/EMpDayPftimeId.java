...
/**
 * EMpDayPftimeId entity. @author MyEclipse Persistence Tools
 */

public class EMpDayPftimeId implements java.io.Serializable {
	...
	/** default constructor */
	public EMpDayPftimeId() {
	}

	/** minimal constructor */
	public EMpDayPftimeId(Long dataId, Date dataDate) {
		this.dataId = dataId;
		this.dataDate = dataDate;
	}

	/** full constructor */
	public EMpDayPftimeId(Long dataId, Date dataDate, Boolean mark,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof EMpDayPftimeId))
			return false;
		EMpDayPftimeId castOther = (EMpDayPftimeId) other;
