...
/**
 * ETotalCurveId entity. @author MyEclipse Persistence Tools
 */

public class ETotalCurveId implements java.io.Serializable {
	...
	/** default constructor */
	public ETotalCurveId() {
	}

	/** full constructor */
	public ETotalCurveId(Long totalId, Date dataTime, Boolean mark, Double p,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ETotalCurveId))
			return false;
		ETotalCurveId castOther = (ETotalCurveId) other;
