...
/**
 * TmpMpMonPowerId entity. @author MyEclipse Persistence Tools
 */

public class TmpMpMonPowerId implements java.io.Serializable {
	...
	/** default constructor */
	public TmpMpMonPowerId() {
	}

	/** minimal constructor */
	public TmpMpMonPowerId(Long dataId, Date dataDate) {
		this.dataId = dataId;
		this.dataDate = dataDate;
	}

	/** full constructor */
	public TmpMpMonPowerId(Long dataId, Date dataDate, Double ct, Double pt,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TmpMpMonPowerId))
			return false;
		TmpMpMonPowerId castOther = (TmpMpMonPowerId) other;
