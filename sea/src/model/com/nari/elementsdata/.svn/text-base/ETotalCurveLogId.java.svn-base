...
/**
 * ETotalCurveLogId entity. @author MyEclipse Persistence Tools
 */

public class ETotalCurveLogId implements java.io.Serializable {
	...
	/** default constructor */
	public ETotalCurveLogId() {
	}

	/** full constructor */
	public ETotalCurveLogId(Long totalId, Date dataTime, Boolean mark,
			Double p, Double q, Integer e, Integer r) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ETotalCurveLogId))
			return false;
		ETotalCurveLogId castOther = (ETotalCurveLogId) other;
