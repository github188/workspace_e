...
/**
 * TmpMpDayPowerId entity. @author MyEclipse Persistence Tools
 */

public class TmpMpDayPowerId implements java.io.Serializable {
	...
	/** default constructor */
	public TmpMpDayPowerId() {
	}

	/** minimal constructor */
	public TmpMpDayPowerId(Long dataId, Date dataDate) {
		this.dataId = dataId;
		this.dataDate = dataDate;
	}

	/** full constructor */
	public TmpMpDayPowerId(Long dataId, Date dataDate, Double ct, Double pt,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TmpMpDayPowerId))
			return false;
		TmpMpDayPowerId castOther = (TmpMpDayPowerId) other;
