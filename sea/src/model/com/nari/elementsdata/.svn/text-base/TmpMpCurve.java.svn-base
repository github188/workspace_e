...
/**
 * TmpMpCurve entity. @author MyEclipse Persistence Tools
 */

public class TmpMpCurve implements java.io.Serializable {
	...
	/** full constructor */
	public TmpMpCurve(Date dataTime, Double ct, Double pt, Boolean mark,
