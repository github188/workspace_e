...
/**
 * EMpMonPftimeId entity. @author MyEclipse Persistence Tools
 */

public class EMpMonPftimeId implements java.io.Serializable {
	...
	/** default constructor */
	public EMpMonPftimeId() {
	}

	/** minimal constructor */
	public EMpMonPftimeId(Long dataId, Date dataDate) {
		this.dataId = dataId;
		this.dataDate = dataDate;
	}

	/** full constructor */
	public EMpMonPftimeId(Long dataId, Date dataDate, Boolean mark,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof EMpMonPftimeId))
			return false;
		EMpMonPftimeId castOther = (EMpMonPftimeId) other;
