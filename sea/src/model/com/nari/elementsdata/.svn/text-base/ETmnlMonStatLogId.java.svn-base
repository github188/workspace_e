...
/**
 * ETmnlMonStatLogId entity. @author MyEclipse Persistence Tools
 */

public class ETmnlMonStatLogId implements java.io.Serializable {
	...
	/** default constructor */
	public ETmnlMonStatLogId() {
	}

	/** full constructor */
	public ETmnlMonStatLogId(String tmnlAssetNo, Date dataDate, Boolean mark,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ETmnlMonStatLogId))
			return false;
		ETmnlMonStatLogId castOther = (ETmnlMonStatLogId) other;
