...
/**
 * EMpMonPowerLogId entity. @author MyEclipse Persistence Tools
 */

public class EMpMonPowerLogId implements java.io.Serializable {
	...
	/** default constructor */
	public EMpMonPowerLogId() {
	}

	/** minimal constructor */
	public EMpMonPowerLogId(Long dataId, Date dataDate) {
		this.dataId = dataId;
		this.dataDate = dataDate;
	}

	/** full constructor */
	public EMpMonPowerLogId(Long dataId, Date dataDate, Double ct, Double pt,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof EMpMonPowerLogId))
			return false;
		EMpMonPowerLogId castOther = (EMpMonPowerLogId) other;
