...
/**
 * TmpTmnlMonStatId entity. @author MyEclipse Persistence Tools
 */

public class TmpTmnlMonStatId implements java.io.Serializable {
	...
	/** default constructor */
	public TmpTmnlMonStatId() {
	}

	/** full constructor */
	public TmpTmnlMonStatId(String tmnlAssetNo, Date dataDate, Boolean mark,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TmpTmnlMonStatId))
			return false;
		TmpTmnlMonStatId castOther = (TmpTmnlMonStatId) other;
