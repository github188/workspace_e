...
/**
 * RTmnlInstDiagramId entity. @author MyEclipse Persistence Tools
 */

public class RTmnlInstDiagramId implements java.io.Serializable {
	...
	/** default constructor */
	public RTmnlInstDiagramId() {
	}

	/** full constructor */
	public RTmnlInstDiagramId(Long instSchemeId, String instlLocDiagram,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof RTmnlInstDiagramId))
			return false;
		RTmnlInstDiagramId castOther = (RTmnlInstDiagramId) other;
