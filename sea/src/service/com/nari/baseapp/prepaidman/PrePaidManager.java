...
public interface PrePaidManager {
	...
	public List<MeterControlInfoBean> queryMeterList(String nodeType, String nodeValue,
			PSysUser userInfo, String protocolCode) throws Exception;
	/**
	 * 全选按钮查询终端电能表信息
	 * @param nodeType
	...
	public List<MeterInfoBean> queryTmnlArrList(String nodeType,
			String nodeValue, PSysUser userInfo, String protocolCode) throws Exception;
}
