 ...
 * @author 杨传文
 */
public interface PowerCtrlQueryDao {
	/**
	 * 按方案ID查询时段控方案执行列表信息
	 * @param schemeId
	 * @return
	 ...
	 * @return
	 */
	public List<PwrctrlSchemeExecBean> findFactctrlSchemeExecByTmnlAssetNo(String tmnlAssetNo) throws DBAccessException;
	 ...
	 * @return  模板明细列表
	 */
	public List<WPwrctrlTemplateDetail> findWPwrctrlTemplateDetailBytemplateId(Long templateId) throws DBAccessException;
