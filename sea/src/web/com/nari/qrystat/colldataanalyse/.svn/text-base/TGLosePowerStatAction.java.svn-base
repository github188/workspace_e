 ...
 * @author 姜炜超
 */
public class TGLosePowerStatAction extends BaseAction{
	//定义日志
	private static final Logger logger = Logger.getLogger(TGLosePowerStatAction.class);
	
	private TGLosePowerStatManager tgLosePowerStatManager;

	public void setTgLosePowerStatManager(
			TGLosePowerStatManager tgLosePowerStatManager) {
		this.tgLosePowerStatManager = tgLosePowerStatManager;
	} 
    ...
    public String loadGridData() throws Exception{
    	...
    	Page<LosePowerStatDto> page = tgLosePowerStatManager.findLosePowerStat(nodeId, nodeType,
