...
public class CreatorPlus extends JFrame implements ActionListener, ChangeListener {
	...
	// We'll need to access this Document in a method, so we made it 
	// a class member
	...
	public CreatorPlus() {
		...
		// This is an auxilliary panel to group together Buttons, Labels and 
		// Spinners
		JPanel p = new JPanel();
		...
		// And then the Spinners themselves are created and associated
		// with a Change Listener - basic Swing
		...
		// The SVGDocument and the SVG Generator are created, in a slightly 
	...
	// Drawing itself, only slightly different from what was done in the previous 
	// application
