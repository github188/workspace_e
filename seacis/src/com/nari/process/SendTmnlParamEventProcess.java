...
public class SendTmnlParamEventProcess implements Runnable{
	...
	public SendTmnlParamEventProcess(EventBean[] newEvents,EventBean[] oldEvents){
	...
	public void run() {
		...
		try {
			...
			if("3".equals(Status)){
				...
				//触发事件：抄读电表数据
				Constant.sendEvent(new RelayMeterReadingEvent(appNo, terminalId, tmnlAssetNo, debugId, "0", meterFlag));//TODU
				log.info("******************************************************************************************************************");
				log.info("******************************************************************************************************************");
				log.info("******************************************************************************************************************");
			}else{
