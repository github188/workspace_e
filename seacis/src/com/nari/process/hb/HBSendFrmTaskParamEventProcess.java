...
public class HBSendFrmTaskParamEventProcess implements Runnable{
	...
	public HBSendFrmTaskParamEventProcess(EventBean[] newEvents,EventBean[] oldEvents){
	...
	public void run() {
		log.debug("【HBSendFrmTaskParamEventProcess下发任务参数开始......】");
		...
		try {
			...
			log.debug("HBSendFrmTaskParamEventProcess下发任务参数结束.....");
