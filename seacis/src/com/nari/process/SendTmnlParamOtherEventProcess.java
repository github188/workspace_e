...
public class SendTmnlParamOtherEventProcess implements Runnable{
	
	private static final Log log = LogFactory.getLog(SendTmnlParamOtherEventProcess.class);
	private EventBean[] newEvents;
	private EventBean[] oldEvents;
	public SendTmnlParamOtherEventProcess(EventBean[] newEvents,EventBean[] oldEvents){
