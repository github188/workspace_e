 ...
 */
public class NodePickPanel extends JPanel implements ActionMap {
     ...
     */
    public NodePickPanel(NodePickerController controller) {
...
//          getSvgInputPanel().getNodeXmlArea().requestFocusInWindow();
    ...
    private boolean isANodePickerComponent(Component component) {
        return SwingUtilities.getAncestorOfClass(NodePickPanel.class,
                                                 component) != null;
    }
